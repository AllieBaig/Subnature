        ...
        <main className="absolute inset-0 overflow-hidden flex flex-col">
          {isLoading ? (
            ...
            <div className="flex-1 flex items-center justify-center px-6">
              <div className={`w-full max-w-sm bg-secondary-system-background ${settings.appearance.uiMode === 'mini' ? 'rounded-2xl p-6' : 'rounded-[2.5rem] p-8'} border border-apple-border shadow-2xl text-center`}>
