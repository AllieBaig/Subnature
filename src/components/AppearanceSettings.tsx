           ...
           <div className="flex flex-col gap-3">
              <div className="grid grid-cols-2 gap-2">
                <button 
                  ...
                  className={`flex flex-col items-center justify-center gap-1 py-4 rounded-2xl border transition-all ${settings.appearance.uiMode === 'mini' ? 'bg-sky-500 border-sky-500 text-white shadow-lg shadow-sky-500/20' : 'bg-secondary-system-background border-apple-border text-system-secondary-label'}`}
                >
                ...
                <button 
                  ...
                  className={`flex flex-col items-center justify-center gap-1 py-4 rounded-2xl border transition-all ${settings.appearance.uiMode === 'pro' ? 'bg-sky-500 border-sky-500 text-white shadow-lg shadow-sky-500/20' : 'bg-secondary-system-background border-apple-border text-system-secondary-label'}`}
                >
